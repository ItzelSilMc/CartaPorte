...
(
	...
	RFCNotificado VARCHAR(13) NULL,
	NombreNotificado VARCHAR(254) NULL,
	NumRegIdTribNotificado VARCHAR(40) NULL,
	ResidenciaFiscalNotificado VARCHAR(3) NULL,
...
CREATE TABLE VMX_FE_CARTAPORTE (
	ID_CARTAPORTE  INT IDENTITY(1,1),
...
-------------------------
-- SE ELIMINO ESTA TABLA POR OBSOLETO
